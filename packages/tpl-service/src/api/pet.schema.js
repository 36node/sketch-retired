  ...
  properties: {
    query: {
      ...
      properties: {
        ...
        tag: { type: "string" },
        age_gt: { type: "integer" },
        birthAt_gt: { tsType: "Date", type: "string", format: "date" },
        birthAt_lt: { tsType: "Date", type: "string", format: "date" },
        grade_gt: { tsType: "Date", type: "string", format: "date" },
        grade_lt: { tsType: "Date", type: "string", format: "date" },
      },
    },
  },
};
        ...
        allOf: [
          {
            ...
            properties: {
              ...
              birthAt: { tsType: "Date", type: "string", format: "date" },
